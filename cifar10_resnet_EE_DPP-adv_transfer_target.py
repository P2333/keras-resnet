...
np.savetxt('cifar10_transfer_acc_models'+str(FLAGS.num_models)+'_lamda'+str(FLAGS.lamda)+'_logdetlamda'+str(FLAGS.log_det_lamda)+'_eps'+str(FLAGS.eps)+'_'+FLAGS.attack_method+'_withensemble_target.txt', acc_record)
