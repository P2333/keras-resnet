...
success_rate = np.zeros((2,21)) #first row is our method, second
...
np.savetxt('output_results/MODIFIED_cifar10_adv_ensemble_acc_models' + str(FLAGS.num_models) + '_lamda' + str(FLAGS.lamda) + '_logdetlamda' + str(FLAGS.log_det_lamda) + '_' + FLAGS.attack_method + '_target.txt', success_rate)
