...
tf.app.flags.DEFINE_string('imagenet_train_dir', '/home/tianyu/adv_train/imagenet_data/train', '')
tf.app.flags.DEFINE_string('imagenet_validation_dir', '/home/tianyu/adv_train/imagenet_data/validation', '')
