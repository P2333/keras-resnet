...
#Adv ensemble acc
CUDA_VISIBLE_DEVICES=3 python cifar10_resnet_EE_DPP-adv_ensemble_eval.py --lamda=2.0 --log_det_lamda=0.3 --num_models=3 --augmentation=True --epoch=180 --baseline_epoch=139 --attack_method=MadryEtAl
...
#Adv transfer acc
CUDA_VISIBLE_DEVICES=0 python cifar10_resnet_EE_DPP-adv_transfer.py --lamda=2.0 --log_det_lamda=0.3 --num_models=3 --augmentation=True --epoch=180 --baseline_epoch=139 --attack_method=MadryEtAl --eps=0.02

CUDA_VISIBLE_DEVICES=0 python cifar10_resnet_EE_DPP-adv_transfer.py --lamda=2.0 --log_det_lamda=0.3 --num_models=3 --augmentation=True --epoch=180 --baseline_epoch=139 --attack_method=MomentumIterativeMethod --eps=0.02

CUDA_VISIBLE_DEVICES=0 python cifar10_resnet_EE_DPP-adv_transfer.py --lamda=2.0 --log_det_lamda=0.3 --num_models=3 --augmentation=True --epoch=180 --baseline_epoch=139 --attack_method=MadryEtAl --eps=0.04
