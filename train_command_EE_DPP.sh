...
CUDA_VISIBLE_DEVICES=0 python cifar10_resnet_EE_DPP-eval_nor_acc.py --lamda=2.0 --log_det_lamda=0.0 --num_models=3 --augmentation=True --epoch=157
...
CUDA_VISIBLE_DEVICES=3 nohup python -u cifar10_resnet_EE_DPP-adv_ensemble_eval_noniterative.py --lamda=2.0 --log_det_lamda=0.5 --num_models=3 --augmentation=True --epoch=159 --attack_method=CarliniWagnerL2 > adv_ensemble_acc_CarliniWagnerL2_model3_lamda2p0_loglamda0p5_CWconstant0p1.out 2>&1 &
CUDA_VISIBLE_DEVICES=0 nohup python -u cifar10_resnet_EE_DPP-adv_ensemble_eval_noniterative.py --lamda=0.0 --log_det_lamda=0.0 --num_models=3 --augmentation=True --epoch=139 --attack_method=CarliniWagnerL2 > adv_ensemble_acc_CarliniWagnerL2_model3_lamda0_loglamda0_CWconstant0p1.out 2>&1 &
CUDA_VISIBLE_DEVICES=1 nohup python -u cifar10_resnet_EE_DPP-adv_ensemble_eval_noniterative.py --lamda=2.0 --log_det_lamda=0.0 --num_models=3 --augmentation=True --epoch=157 --attack_method=CarliniWagnerL2 > adv_ensemble_acc_CarliniWagnerL2_model3_lamda2p0_loglamda0_CWconstant0p001.out 2>&1 &
...
CUDA_VISIBLE_DEVICES=1 nohup python -u cifar10_resnet_EE_DPP-adv_ensemble_eval_noniterative.py --lamda=2.0 --log_det_lamda=0.5 --num_models=3 --augmentation=True --epoch=159 --attack_method=ElasticNetMethod > adv_ensemble_acc_ElasticNetMethod_model3_lamda2p0_loglamda0p5_constant5p0_beta0p01.out 2>&1 &
CUDA_VISIBLE_DEVICES=0 nohup python -u cifar10_resnet_EE_DPP-adv_ensemble_eval_noniterative.py --lamda=0.0 --log_det_lamda=0.0 --num_models=3 --augmentation=True --epoch=139 --attack_method=ElasticNetMethod > adv_ensemble_acc_ElasticNetMethod_model3_lamda0_loglamda0_constant5p0_beta0p01.out 2>&1 &
CUDA_VISIBLE_DEVICES=3 nohup python -u cifar10_resnet_EE_DPP-adv_ensemble_eval_noniterative.py --lamda=2.0 --log_det_lamda=0.0 --num_models=3 --augmentation=True --epoch=157 --attack_method=ElasticNetMethod > adv_ensemble_acc_ElasticNetMethod_model3_lamda2p0_loglamda0_constant5p0_beta0p01.out 2>&1 &
...
CUDA_VISIBLE_DEVICES=0 nohup python -u cifar10_resnet_EE_DPP-adv_ensemble_eval.py --lamda=2.0 --log_det_lamda=0.5 --num_models=3 --augmentation=True --epoch=159 --baseline_epoch=139 --attack_method=MadryEtAl > MODIFIED_adv_ensemble_acc_MadryEtAl_model3_lamda2p0_loglamda0p5.out 2>&1 &
CUDA_VISIBLE_DEVICES=1 nohup python -u cifar10_resnet_EE_DPP-adv_ensemble_eval.py --lamda=2.0 --log_det_lamda=0.5 --num_models=3 --augmentation=True --epoch=159 --baseline_epoch=139 --attack_method=MomentumIterativeMethod > MODIFIED_adv_ensemble_acc_MomentumIterativeMethod_model3_lamda2p0_loglamda0p5.out 2>&1 &
CUDA_VISIBLE_DEVICES=2 nohup python -u cifar10_resnet_EE_DPP-adv_ensemble_eval.py --lamda=2.0 --log_det_lamda=0.5 --num_models=3 --augmentation=True --epoch=159 --baseline_epoch=139 --attack_method=BasicIterativeMethod > MODIFIED_adv_ensemble_acc_BasicIterativeMethod_model3_lamda2p0_loglamda0p5.out 2>&1 &
...
CUDA_VISIBLE_DEVICES=0 nohup python -u cifar10_resnet_EE_DPP-adv_ensemble_eval.py --lamda=2.0 --log_det_lamda=0.0 --num_models=3 --augmentation=True --epoch=157 --baseline_epoch=139 --attack_method=MadryEtAl > MODIFIED_adv_ensemble_acc_MadryEtAl_model3_lamda2p0_loglamda0.out 2>&1 &
CUDA_VISIBLE_DEVICES=1 nohup python -u cifar10_resnet_EE_DPP-adv_ensemble_eval.py --lamda=2.0 --log_det_lamda=0.0 --num_models=3 --augmentation=True --epoch=157 --baseline_epoch=139 --attack_method=MomentumIterativeMethod > MODIFIED_adv_ensemble_acc_MomentumIterativeMethod_model3_lamda2p0_loglamda0.out 2>&1 &
CUDA_VISIBLE_DEVICES=0 nohup python -u cifar10_resnet_EE_DPP-adv_ensemble_eval.py --lamda=2.0 --log_det_lamda=0.0 --num_models=3 --augmentation=True --epoch=157 --baseline_epoch=139 --attack_method=BasicIterativeMethod > MODIFIED_adv_ensemble_acc_BasicIterativeMethod_model3_lamda2p0_loglamda0.out 2>&1 &
